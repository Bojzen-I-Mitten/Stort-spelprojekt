...
namespace thomas
{
	namespace utils
	{
		...
		HRESULT __stdcall D3DDevice::CreateTexture2D(std::string name, const D3D11_TEXTURE2D_DESC * pDesc, const D3D11_SUBRESOURCE_DATA * pInitialData, ID3D11Texture2D ** ppTexture2D)
		{
			static int m_count;
			HRESULT hr = m_device->CreateTexture2D(pDesc, pInitialData, ppTexture2D);
		...
		HRESULT __stdcall D3DDevice::CreateShaderResourceView(std::string name, ID3D11Resource * pResource, const D3D11_SHADER_RESOURCE_VIEW_DESC * pDesc, ID3D11ShaderResourceView ** ppSRView)
		{
			static int m_count;
			HRESULT hr = m_device->CreateShaderResourceView(pResource, pDesc, ppSRView);
		...
		HRESULT __stdcall D3DDevice::CreateRenderTargetView(std::string name, ID3D11Resource * pResource, const D3D11_RENDER_TARGET_VIEW_DESC * pDesc, ID3D11RenderTargetView ** ppRTView)
		{
			static int m_count;
			HRESULT hr = m_device->CreateRenderTargetView(pResource, pDesc, ppRTView);
