...
namespace thomas {
	namespace animation {
		...
		*/
		void SkeletonPart::assemble(const AnimatedSkeleton &parent, math::Matrix* array) const {
		...
		*/
		void SkeletonPart::assemble(const AnimatedSkeleton &parent, const math::Matrix &modelMatrix, math::Matrix* array) const {
			for (unsigned int i = 0; i < _bones.size(); i++)
