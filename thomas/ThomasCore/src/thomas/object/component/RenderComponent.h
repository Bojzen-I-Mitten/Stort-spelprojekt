...
namespace thomas
{
	...
	namespace object
	{
		namespace component
		{
			...
			protected:
				void SubmitSkinningPart(Camera* camera, unsigned int i, const thomas::resource::shaderproperty::ShaderPropertyStatic* property_data, uint32_t num_prop);
				virtual void SubmitPart(Camera* camera,  unsigned int i, const thomas::resource::shaderproperty::ShaderPropertyStatic* property_data, uint32_t num_prop);
			protected:
