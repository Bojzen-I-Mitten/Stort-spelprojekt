...
namespace thomas
{
	namespace object
	{
		namespace component
		{
			...
			math::Vector4 ParticleEmitterComponent::GetStartColor() const
			{
				return m_particleBufferStruct.startColor;
			}
			...
			math::Vector4 ParticleEmitterComponent::GetEndColor() const
			{
				return m_particleBufferStruct.endColor;
			}
