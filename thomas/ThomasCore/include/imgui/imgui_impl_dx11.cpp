...
void ImGui_ImplDX11_RenderDrawData(ImDrawData* draw_data)
{
    ...
    // Copy and convert all vertices into a single contiguous buffer1
    ...
    // Setup orthographic projection matrix into our constant buffer1
    {
